      ...
      AIMenuSuggestion.create(
        ...
        meals: [
          Meal(
            ...
            type: "breakfast",
            calories: 280,
            timestamp: DateTime(_selectedDay.year, _selectedDay.month, _selectedDay.day, 8, 0),
          ...
          Meal(
            ...
            type: "lunch",
            calories: 420,
            timestamp: DateTime(_selectedDay.year, _selectedDay.month, _selectedDay.day, 12, 30),
          ...
          Meal(
            ...
            type: "dinner",
            calories: 380,
            timestamp: DateTime(_selectedDay.year, _selectedDay.month, _selectedDay.day, 19, 0),
